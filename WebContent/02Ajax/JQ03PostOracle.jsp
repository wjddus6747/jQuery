...
<script>
	$(function() {
		$('#btnLogin2').click(function() {
			...
			조립해주는 역할을 하는 메소드로, 하위 태그들이 많을때
			사용함
			 */
			var s_params = $('#loginFrm').serialize();

			$.post(s_url, s_params, function(resData) {
		...
		<div class="row" id="loginTable">
			<form id="loginFrm" onsubmit="return checkFrm();">
				<table class="table table-bordered">
					<tr>
						<td>아이디</td>
						<td><input type="text" name="user_id" value="kosmo" /></td>
					</tr>
					<tr>
						<td>패스워드</td>
						<td><input type="password" name="user_pw" value="1111" /></td>
					</tr>
				</table>
